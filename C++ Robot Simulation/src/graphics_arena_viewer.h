...
class GraphicsArenaViewer : public GraphicsApp {
 public:
  ...
  /**
   * @brief Handle the user pressing the toggle food button on the GUI.
   *
   * This will toggle whether Food is in the Arena or not.
   */
  void OnToggleFoodBtnPressed();

  /**
   * @brief Handle the user pressing the new game button on the GUI.
   *
   * This will reset entity positions.
   */
 ...
 private:
  ...
  /**
   * @brief Display game over window.
   */
  ...
  nanogui::Button *toggle_food_button_{nullptr};

  // Game status window (Win/Lose)
  nanogui::ref<nanogui::Window> status_window_{nullptr};
};
