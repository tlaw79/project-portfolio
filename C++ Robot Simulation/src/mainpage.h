/*! \mainpage Robot Simulation: Iteration 3
 * 
 * @copyright 2017 3081 Staff, All rights reserved.
 *
 * \section intro_sec Robot Simulation: Iteration 3
 * 
...
3) Enter the following command: make clean\n
...
Play button: Play/Pause the simulation.\n
New Game button: Restart the simulation.\n
Number of Robots slider: Number of robots in the simulation.\n
Number of Lights slider: Number of lights in the simulation.\n
Number of Food slider: Number of food in the simulation.\n
Ratio slider: Ratio of robots that fear to robots that explore.\n
Sensitivity slider: How sensitive robots are to stimuli.\n
