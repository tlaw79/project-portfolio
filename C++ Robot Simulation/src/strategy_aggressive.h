/**
 * @file strategy_aggressive.h
 *
 * @copyright 2017 3081 Staff, All rights reserved.
 */

#ifndef SRC_STRATEGY_AGGRESSIVE_H_
#define SRC_STRATEGY_AGGRESSIVE_H_
 ...
 ******************************************************************************/
/**
 * @brief Class representing the aggressive movement strategy,
 * according to the Braitenberg vehicle model.
 */
class StrategyAggressive : public StrategyMovement {
 public:
  /**
   * @brief Constructor.
   */
   ...
   */
  virtual ~StrategyAggressive() = default;
...
#endif  // SRC_STRATEGY_AGGRESSIVE_H_
